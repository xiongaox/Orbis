    ...
    return (
        <>
            <div className="modal-backdrop" onClick={(e) => e.target === e.currentTarget && onClose()}>
                <div className="modal-card-lg animate-in zoom-in-95 fade-in duration-200">
                    {/* 头部 */}
                    ...
                    <div className="flex gap-4 flex-1 min-h-0">
                        {/* 左侧 Tab 菜单 */}
                        <div className="w-28 shrink-0 flex flex-col gap-0.5 overflow-y-auto max-h-[55vh]">
                            {allTabs.map((tag) => {
                        ...
                        {/* 右侧案例列表 */}
                        <div className="flex-1 min-w-0 overflow-y-auto max-h-[55vh]">
                            {loading ? (
