...
export default function JsonImportModal<T>({
    ...
    return (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4" role="dialog" aria-modal="true">
            ...
            {/* Split Layout Modal */}
            <div className="relative w-full max-w-3xl h-[520px] bg-background rounded-2xl shadow-2xl overflow-hidden border border-border flex animate-in zoom-in-95 duration-300">
                ...
                <div className="w-[220px] bg-muted/30 border-r border-border flex flex-col p-6 relative overflow-hidden flex-shrink-0">
                    ...
                    <div className="mt-auto relative z-10">
                        <button
                            ...
                            className="w-full flex items-center gap-2.5 p-2.5 rounded-xl bg-muted/40 hover:bg-muted border border-transparent hover:border-border transition-all text-left group"
                        >
                ...
                <div className="flex-1 bg-background flex flex-col relative w-full overflow-hidden">
                    ...
                    <button
                        onClick={handleClose}
                        className="absolute top-4 right-4 p-1.5 rounded-full text-muted-foreground hover:text-foreground hover:bg-muted transition-all z-20"
                    >
                        <X className="w-4 h-4" />
                    </button>
                            ...
                            <div className="h-full flex flex-col animate-in fade-in slide-in-from-right-4 duration-300">
                                ...
                                <div className="mt-4 flex justify-between items-center flex-shrink-0">
                                    ...
                                    <button
                                        ...
                                        className="px-4 py-2 bg-primary text-primary-foreground hover:bg-primary/90 text-sm font-semibold rounded-lg transition-all shadow-sm active:scale-95"
                                    >
                                        确认导入
                                    </button>
                                </div>
                        ...
                        {step === 'result' && importResult && (
                            <div className="h-full flex flex-col items-center justify-center animate-in zoom-in-95 duration-300">
                                ...
                                <button
                                    ...
                                    className="px-10 py-3 bg-primary text-primary-foreground hover:bg-primary/90 font-semibold rounded-xl transition-all shadow-lg active:scale-95"
                                >
                                    完成
                                </button>
                            </div>
