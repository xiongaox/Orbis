 ...
 *
 * 主要导出：
 * - `Relation`, `UNIFIED_COLOR`, `assignTracks`, `TRACK_HEIGHT`, `GUIDE_LINE_EXTRA`, `ITEM_WIDTH`, `GAP`, `START_X`, `getX`, `needsGuideLine`, `calculateTrackY`, `calculateActualHeight`
 *
 * 依赖关系：
 * - 上游依赖：无显式外部模块依赖
