    ...
    if (palace.position === 5) {
        return (
            <button type="button" onClick={onSelect} className={baseClass}>
                <div className={`w-full h-full flex flex-col p-0.5 ${showChangSheng ? 'justify-center gap-y-1' : 'justify-evenly gap-y-1'}`}>
                    {/* 第一行：暗干 - 与普通宫位对齐 */}
                    ...
                    <div className="grid grid-cols-3 w-full items-end">
                        <div className="flex flex-col items-center justify-end leading-none">
                            ...
                            {showChangSheng && <span className="text-[12px] text-muted-foreground whitespace-nowrap">&nbsp;</span>}
                        </div>
                        <div className="flex flex-col items-center justify-end leading-none">
