 ...
 *
 * 主要导出：
 * - `TIAN_GAN`, `DI_ZHI`, `CATEGORIES`, `LUNAR_MONTH_MAP`, `LUNAR_DAY_MAP`, `HOUR_MAP`, `AUTHOR_MAP`, `DAY_MASTER_CATEGORIES`, `QIMEN_CATEGORIES`
 *
 * 依赖关系：
 * - 上游依赖：内部模块 `ganZhi`
...
import { TIAN_GAN as BASE_TIAN_GAN, DI_ZHI as BASE_DI_ZHI } from '../../constants/ganZhi';

export const TIAN_GAN: string[] = [...BASE_TIAN_GAN];
export const DI_ZHI: string[] = [...BASE_DI_ZHI];
