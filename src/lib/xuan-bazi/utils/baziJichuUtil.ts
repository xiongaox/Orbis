 ...
 *
 * 主要导出：
 * - `getTianGanIndex`, `getDiZhiIndex`, `getTianGanByIndex`, `getDiZhiByIndex`, `getTianGanWuXing`, `getDiZhiWuXing`, `getTianGanYinYang`, `getDiZhiCangGan`, `getNaYin`, `getNaYinWuXing`, `getKongWang`, `getShiShen`, `getShiErZhangSheng`, `getShengXiao`, `parseGanZhi`, `combineGanZhi`, `getGanZhiIndexDiff`, `getNextGanZhi`, `getGanZhiIndex`, `getGanZhiByIndex`, `SHI_SHEN_ABBR`, `getShiShenAbbr`, `getXunKong`
 *
 * 依赖关系：
 * - 上游依赖：无显式外部模块依赖
